...
int main() {
	...
	int num_pt = 0;
	for(int i = 0; i < N; i++) {
		//fscanf(read_file, "%lf %lf %lf %lf %lf", &particles[i].position.x, &particles[i].position.y, &particles[i].mass, &particles[i].velocity.x, &particles[i].velocity.y);
	...
	for( int i = 0; i < N; i++) {
		...
		fprintf(output_file, "%lf %lf %lf %lf %lf \n", particles[i].position.x, particles[i].position.y, particles[i].mass, particles[i].velocity.x, particles[i].velocity.y);
